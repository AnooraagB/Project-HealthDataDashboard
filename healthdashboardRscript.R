...
# Query the database for the first 10 dates when the user was active
...
# Query the database for first 10 rows (by date) when the user slept for 8 hours
...
# Query the database for hours of sleep of first 10 rows when the user was happy
